...
user = 'student id' # this is your student id
...
time.sleep(2) # lets page load before continue running code or else error will occur
username_textbox = web.find_element_by_xpath('//*[@id="UserName"]') # this is your student id 
username_textbox.send_keys(user) # this is to send student id
