...
def attendance():
  ...
  # There is no confirm button in edge unlinke chrome which makes automation easier won't tell you which lines go find out yourself not gonna spoon feed you people that much
